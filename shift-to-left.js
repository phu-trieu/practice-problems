...
// 5 << 2 = 5 * 2 ^ 2 = 5 * 4 = 20
// Write a recursive function that mimics(without the use of <<) the left shift
...
// This challenge is more like recreating of the left shift operation, thus, the use
// of the operator directly is prohibited.
